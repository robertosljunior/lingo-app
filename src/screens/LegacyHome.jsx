// LegacyHome.jsx — the V1 Home, moved here VERBATIM from Home.jsx by V2.20-R §5.
// It is the legacy product: Bob, "Bora soltar o inglês hoje", themes/A1–B2, the
// V1 lesson card, YAML import, prompt generation, adaptive practice and the SRS
// review — none of which belong to the V2 learner experience (§10).
//
// It is only reachable when the learner explicitly opts out of V2
// (`v2_learner_experience_enabled === false`); see Home.jsx, the thin router
// that now owns SCREENS.HOME. Behaviour is unchanged on purpose.

...
export default function LegacyMistakes() {
  ...
  return (
    <div className="phone">
      ...
      <div className="screen-body" style={{ paddingTop: 12, paddingBottom: 100, gap: 10 }}>
        ...
        {hasSkills ? <SkillList profiles={skillProfiles} /> : <LegacyMistakeList mistakes={mistakes} />}
      </div>
      <BottomNav active="mistakes" onNavigate={setTab} />
    </div>
  )
...
function LegacyMistakeList({ mistakes }) {

// LegacyTrainingHub.jsx — the V1 Training Hub, extracted verbatim from the
// former TrainingHub (Slice V2.18 §2). Behaviour is preserved: themes, levels,
// generated lessons, skill practice, "domínio estimado". It renders ONLY when
// `v2_learner_experience_enabled` is false; the router in TrainingHub.jsx picks
// between this and V2LearnerHome. The temporary "Nova experiência V2" card was
// removed here because, when the V2 flag is ON, Training IS the V2 home — the
// two pedagogical worlds never share a surface (§21).
...
export default function LegacyTrainingHub() {
  const { db, activeProfile, settings, latest, lessons, sessions, skillProfiles, startLesson, startPracticeSession, generateAdaptiveLesson, showToast, setTab, navigate } = useApp()
